...
def encode_speed_test():
    ...
    # 求平均
    encodetimes["ECB_encodetime"].append(sum(encodetimes["ECB_encodetime"]) / 10)
    encodetimes["CBC_encodetime"].append(sum(encodetimes["CBC_encodetime"]) / 10)
    encodetimes["CFB_encodetime"].append(sum(encodetimes["CFB_encodetime"]) / 10)
    encodetimes["OFB_encodetime"].append(sum(encodetimes["OFB_encodetime"]) / 10)
    encodespeeds["ECB_speeds"].append(sum(encodespeeds["ECB_speeds"]) / 10)
    encodespeeds["CBC_speeds"].append(sum(encodespeeds["CBC_speeds"]) / 10)
    encodespeeds["CFB_speeds"].append(sum(encodespeeds["CFB_speeds"]) / 10)
    encodespeeds["OFB_speeds"].append(sum(encodespeeds["OFB_speeds"]) / 10)

    with open("encode_speed_result.txt", "a") as f:
...
def decode_speed_test():
    ...
    # 求平均
    decodetimes["ECB_decodetime"].append(sum(decodetimes["ECB_decodetime"]) / 10)
    decodetimes["CBC_decodetime"].append(sum(decodetimes["CBC_decodetime"]) / 10)
    decodetimes["CFB_decodetime"].append(sum(decodetimes["CFB_decodetime"]) / 10)
    decodetimes["OFB_decodetime"].append(sum(decodetimes["OFB_decodetime"]) / 10)
    decodespeeds["ECB_speeds"].append(sum(decodespeeds["ECB_speeds"]) / 10)
    decodespeeds["CBC_speeds"].append(sum(decodespeeds["CBC_speeds"]) / 10)
    decodespeeds["CFB_speeds"].append(sum(decodespeeds["CFB_speeds"]) / 10)
    decodespeeds["OFB_speeds"].append(sum(decodespeeds["OFB_speeds"]) / 10)

    with open("decode_speed_result.txt", "a") as f:
